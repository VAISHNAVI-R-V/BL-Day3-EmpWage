...
public class EmpWageComputationImpl {
    ...
    void addCompany(String company, int wagePerHrs, int numOfWorkingDays, int maxHrsPerMonth){
        companyAraay[numOfCompany] = new Company(company, wagePerHrs, numOfWorkingDays, maxHrsPerMonth);
        numOfCompany++;
    }
